...
<rules>
1. Output ONLY the translation. No explanations, prefixes, or XML tags (including </input>)
...
8. Input is wrapped in <input> tags. Translate ONLY the content inside; never output the tags themselves
</rules>